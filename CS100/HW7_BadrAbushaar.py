...
def litCricFriend(wordList, text):
    ...
    for word in splitText:
        strippedText.append(word.strip(string.punctuation))
    ...
    for word in wordList:
        if word in strippedText:
            wordSum += strippedText.count(word.lower())
    ...
    frequency = wordSum / len(strippedText)
    return frequency
...
print(litCricFriend(['a', 'an'], theBells)) #Poe
print(litCricFriend(['a', 'an'], cantoXII)) #Neruda
print(litCricFriend(['the'], theBells)) #Poe
print(litCricFriend(['the'], cantoXII)) #Neruda
...
'''
The results show that Poe uses 'a' and 'an' more frequently than Neruda. (~3.5x more frequently)
It also shows that Poe uses 'the' more frequently than Neruda. (~2.5x more frequently)
'''
